  ...
  return (
    <>
      ...
      <Navbar
        ...
        style={{
          background: mode === "dark" ? "rgb(30, 41, 59)" : "#2d3b6d", // Example: Adjusting navbar color to match hero section color
        }}
      >
        {/* Desktop View */}
        <div className="flex items-center justify-between text-blue-gray-900">
          ...
          <Link to={"/"}>
            ...
            >
              {/* Logo Image */}
              <img
                className="w-12 h-12 rounded-full" // Make the logo round and clearer
                src={logo}
                alt="BlogVerse Logo"
              />
              {/* Logo Text */}
                ...
                >
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M21.752 15.002A9.718 9.718 0.5.5 1"
                    />
                  </svg>
                </IconButton>
              )}
